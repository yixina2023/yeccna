...
//    Route::post('like/del', 'user.UserController/like_del')->name('likeDel');//取消点赞
    ...
    Route::get('rank/integral', 'v1.user.UserBillController/integral_rank')->name('integralRank');//积分排行榜
    Route::get('rank/product_list', 'v1.user.UserBillController/product_list')->name('rankProductList');//商品排行榜
    Route::post('rank/product_user_rank', 'v1.user.UserBillController/product_user_rank')->name('rankProductUserRank');//商品排行榜
